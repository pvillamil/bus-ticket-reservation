    ...
    <div id="content">
    	<div id="gallerycontainer">
			<div class="portfolio-area" style="margin:0 auto; padding:140px 20px 20px 20px; width:820px;">	
				<div id="contactleft">
					SSS BUS<br>
(SSS Travels, INCORPORATED)<br>
Duwakot,Bhaktapur<br>
    SSS Travels Co., Duwakot<br>
Phone:  +977-9843303885<br><br>

SSS BUS<br>
(SSS Travels, INCORPORATED)<br>
Baneshwor,Kathmandu<br>
SSS Travels Co., Baneshwor<br>
Phone: +977-9803089100<br><br>

SSS BUS<br>
(SSS Travels, INCORPORATED)<br>
swyambu,Kathmandu<br>
SSS Travels Co., swyambu<br>
Phone: +977-9803122194<br><br>
				</div><br>
				<div id="contactright">
					<h3>Message Form</h3>
					<form class="validate" action="messageexec.php" method="POST">
                        ...
                        <p>
                            ...
                            <input id="email" class="contactform" placeholder="Example: ram@gmail.com" type="text" name="email" />
                        </p>
                        <p>
